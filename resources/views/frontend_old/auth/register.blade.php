    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1" id="login_wrap">
                ...
                <p class="help-block">Регистрация</p>
                <hr>
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <form action="{{ action('Frontend\AccountController@register', ['domain' => $project->domain]) }}" method="post">
                            {{ csrf_field() }}
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    <label>Имя</label>
                                    <input type="text" name="name" class="form-control" placeholder="Ваше имя" required="required" maxlength="40">
                            ...
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    ...
                                    <input type="password" name="password_check" class="form-control" placeholder="Подтвердите пароль" required="required" minlength="8" maxlength="20">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-default btn-success btn-block">Зарегистрироваться</button>
                        </form>
                    </div>
                </div>
