...
<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/frontend_old/css/clean-blog.min.css') }}">
        ...
        @endforeach
        @endif
        <link rel="stylesheet" href="{{ asset('assets/frontend_old/css/all.css') }}">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.3/jquery.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
        <script src="{{ asset('assets/frontend_old/js/clean-blog.min.js') }}"></script>
        ...
        @endforeach
        @endif
        <script src="{{ asset('assets/frontend_old/js/all.js') }}"></script>
