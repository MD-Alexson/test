...
<section class="cabinet-holder">
    <section class="cabinet-content">
        ...
        <div class="content-main">
            <section class="tariff" style="padding-top: 0px;">
                <div class="holder">
                    <div class="material-note" style="margin-bottom: 40px;">
                        Упс! Похоже срок действия вашего аккаунта истек!<br/>
                        Необходимо продлить.<br/>
                        Выберите подходящий тарифный план и переходите к оплате.
                    </div>
