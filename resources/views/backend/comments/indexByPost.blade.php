        ...
        <div class="content-main">
            ...
            <div class="project-top">
                <div class="project-left">
                    <div class="project-top-title">Комментарии к публикации {{ $post->name }}</div>
                    <div class="project-top-num">{{ $post->comments->count() }}</div>
                </div>
            </div>
            <div class="content-back">
                <a href="/comments">К списку всех комментариев</a>
            </div>
            ...
            <div class="add-project">
                <div class="add-project-title">Пока нет комментариев к данной публикации</div>
                <div class="add-project-button">
                    <a href="/comments" class="green-button fancybox">К списку всех комментариев</a>
                </div>
            </div>
            @endif
        </div>
