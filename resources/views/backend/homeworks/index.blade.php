        ...
        <div class="content-main">
            ...
            <div class="project-top">
                <div class="project-left">
                    <div class="project-top-title">Выполненные домашние задания</div>
                    <div class="project-top-num">{{ $project->homeworks->count() }}</div>
                </div>
            </div>
                ...
                <div class="material-table">
                    <table>
                        ...
                        <tr class="row" data-id="{{ $homework->id }}">
                            ...
                            <td><a href="/homeworks/by_post/{{ $homework->post->id }}">{{ $homework->post->name }}</a></td>
                            <td>
            ...
            <div class="add-project">
                <div class="add-project-title">Пока нет выполненных домашних заданий</div>
            </div>
            @endif
        </div>
    </section>
