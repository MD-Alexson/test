        ...
        <div class="content-main">
            ...
            <div class="project-top">
                <div class="project-left">
                    <div class="project-top-title">Все категории</div>
                    <div class="project-top-num">{{ $categories->count() }}</div>
                </div>
                <div class="project-right">
                    <a href="/categories/add" class="green-button float-right">Добавить категорию</a>
                    <a href="/categories/order" class="white-button float-right">Порядок отображения</a>
                </div>
            </div>
                ...
                <div class="material-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a data-sort="order" href='/sort/categories/order/{{ $order }}' class='table-sort'>#</a></td>
                        ...
                        <tr class="row" data-id="{{ $category->id }}" id="row{{ $category->id }}">
                            ...
                            <td><a href="/categories/order" title="Изменить порядок">{{ $category->order }}</a></td>
                            <td>
