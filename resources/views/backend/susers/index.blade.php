...
<section class="cabinet-holder">
    <section class="cabinet-content">
        ...
        <div class="content-main">
            @if($project->susers->count())
            <div class="project-top">
                <div class="project-left">
                    <div class="project-top-title">Пользователи</div>
                    <div class="project-top-num">{{ $project->susers->count() }}</div>
                </div>
            ...
            <div class="content-users-data">
                <a href="#popup_data" class="fancybox">Отправить доступ всем пользователям</a>
            </div>
                ...
                <div class="material-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a data-sort="level_id" href='/sort/users/level_id/{{ $order }}' class='table-sort'>Уровень доступа</a></td>
