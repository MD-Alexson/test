                        ...
                        <div class="add-mat-right">
                            <div class="check-list">
                                ...
                                <div class="check-block">
                                    ...
                                    <label for="ipr_lvl{{ $ipr_level->id }}" class="check-label"><strong>{{ $ipr_level->name }}</strong>@if($user->ipr_levels()->where('id', $ipr_level->id)->count()): <span style="font-family: monospace">{{ $user->ipr_levels()->where('id', $ipr_level->id)->first()->pivot->key }}</span>@endif</label>
                                </div>
                                @endforeach
                            </div>
                        </div>
