        ...
        <div class="content-main">
            ...
            <div class="project-top">
                <div class="project-left">
                    <div class="project-top-title">Порядок всех публикаций</div>
...
<div id="popup_ok" class="popup-min">
    <div class="popup-min-content">
        ...
        <div class="popup-min-text">Вы успешно установили последовательность всех публикаций!</div>
    </div>
...
<script type="text/javascript">
    function order(){
        ...
        $.ajax({
            url: '/posts/order_change/?' + nestedArray,
