        ...
        <div class="content-main">
            ...
            <div class="project-top">
                <div class="project-left">
                    <div class="project-top-title">Все публикации</div>
                    <div class="project-top-num">{{ $project->posts->count() }}</div>
                </div>
            ...
            <div class="material-block">
                ...
                <?php
                if(Session::get('sort.posts_all.order') === 'desc'){
                    $order = 'asc';
                } else {
                    $order = 'desc';
                }
                ...
                <div class="material-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a data-sort="order_all" href='/sort/posts_all/order_all/{{ $order }}' class='table-sort'>#</a></td>
                            <td><a data-sort="name" href='/sort/posts_all/name/{{ $order }}' class='table-sort'>Название</a></td>
                            <td><a data-sort="category_id" href='/sort/posts_all/category_id/{{ $order }}' class='table-sort'>Категория</a></td>
                            <td>Уровни доступа</td>
                            <td><a data-sort="status" href='/sort/posts_all/status/{{ $order }}' class='table-sort'>Статус</a></td>
                            <td>Активность</td>
                            <td class="table-icons" style="text-align: center">Действия</td>
                        </tr>
                        @foreach($posts as $post)
                        <tr class="row" data-id="{{ $post->id }}" id="row{{ $post->id }}">
                            <td><input name="check" type="checkbox" class="check"></td>
                            <td><a href="posts/order" title="Изменить порядок">{{ $post->order_all }}</a></td>
                            <td>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var sort = "{{ Session::get('sort.posts_all.order_by') }}";
