...
class GetResponse {
    ...
    public function getCampaigns() {
        return $this->call('campaigns?page=1&perPage=1000&sort[name]=asc');
    }
     ...
     * @return mixed
     */
    public function updateCampaign($camp_id, $params = array()) {
        return $this->call('campaigns/' . $camp_id, 'POST', $params);
    }
