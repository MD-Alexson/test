...
class EmailController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['title']         = "Настройки рассылок / ".$project->name;
        $emails            = $project->emails()->orderBy('id', 'desc')->get();
        return view('backend.emails.index')->with('data', $data)->with('project', $project)->with('emails', $emails);
    }
