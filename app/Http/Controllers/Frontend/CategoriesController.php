...
class CategoriesController extends Controller
{
    ...
    public function show($domain, $cat_id){
        ...
        return view('frontend.postsByCat')->with('data', $data)->with('posts', $posts)->with('cats', $cats)->with('category', $category)->with('project', $project)->with('menu', $menu)->with('subcats', $subcats);
    }
